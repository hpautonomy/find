...
@JsonDeserialize(builder = RelatedUsersViewConfig.RelatedUsersViewConfigBuilder.class)
public class RelatedUsersViewConfig extends SimpleComponent<RelatedUsersViewConfig> {
    ...
    public static class RelatedUsersViewConfigBuilder {
